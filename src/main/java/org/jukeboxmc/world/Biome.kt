 ...
 * @version 1.0
 */
enum class Biome(val id: Int, val identifier: String, val biomeName: String) {
    OCEAN(0, "ocean", "Ocean"),
    ...
    DESERT_HILLS(17, "desert_hills", "Desert Hills"), FOREST_HILLS(
        18,
        "forest_hills",
        "Forest Hills",
    ),
    ...
    LUSH_CAVES(187, "lush_caves", "Lush Caves"), DRIPSTONE_CAVES(
        188,
        "dripstone_caves",
        "Dripstone Caves",
    ),

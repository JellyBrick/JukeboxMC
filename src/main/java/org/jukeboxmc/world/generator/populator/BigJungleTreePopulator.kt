...
import org.jukeboxmc.world.generator.thing.tree.BigJungleTree
 ...
 * @version 1.0
 */
class BigJungleTreePopulator : Populator() {
    ...
    override fun populate(
        ...
        for (i in 0 until amount) {
            ...
            BigJungleTree(10, 20).create(random, chunkManager, Vector(x, y, z))
        }
    }

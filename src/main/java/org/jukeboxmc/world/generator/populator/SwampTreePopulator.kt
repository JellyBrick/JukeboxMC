...
import org.jukeboxmc.world.generator.thing.tree.SwampTree
 ...
 * @version 1.0
 */
class SwampTreePopulator : Populator() {
    ...
    override fun populate(
        ...
        for (i in 0 until amount) {
            ...
            SwampTree(random.nextInt(4) + 5).create(random, chunkManager, x, y, z)
        }
    }

 ...
 * @version 1.0
 */
class BlockBirchStandingSign : BlockSign {
    ...
    override fun placeBlock(
        ...
        if (blockFace == BlockFace.UP) {
            ...
            val blockWallSign: BlockBirchWallSign =
                Block.Companion.create<BlockBirchWallSign>(BlockType.BIRCH_WALL_SIGN)
    ...
    override fun toItem(): Item {
        return Item.Companion.create<Item>(ItemType.BIRCH_SIGN)
    }
}